...
export const MINION_MEALS: Meal[] = [
  {
    id: 'us-minion-hotdog', park: 'universal', area: 'Minion Land', day: DAY,
    name: 'Minion Hot Dog', priceRange: '$14', tasteRating: 5, photogenicRating: 5, typicalWaitMin: 10,
    recommended: ['Hot dog con pan amarillo temático', 'papas + pickles incluidos'],
    addOns: [], photoTip: 'Foto tipo flat-lay desde arriba, con el letrero de Minion Café de fondo.',
    dietary: 'Contiene lácteos y gluten — no vegetariano ni vegano',
    guide: 'El plato más icónico de Minion Café. Mejor momento: 9-10 AM (café vacío) o 2-3 PM.',
  },
  {
    id: 'us-minion-banana-split', park: 'universal', area: 'Minion Land', day: DAY,
    name: 'Banana Split Minion', priceRange: '$8', tasteRating: 4, photogenicRating: 5, typicalWaitMin: 10,
    recommended: ['Cara de minion hecha con toppings', 'crema batida + cereza'],
    addOns: [], photoTip: 'Macro close-up de la cara de minion en los toppings; hora dorada para luz cálida.',
    dietary: 'Vegetariano — no vegano (lácteos)',
  },
  {
    id: 'us-minion-lemonade', park: 'universal', area: 'Minion Land', day: DAY,
    name: 'Minion Lemonade (vaso souvenir)', priceRange: '$6.50', tasteRating: 4, photogenicRating: 5, typicalWaitMin: 5,
    recommended: ['Pide el vaso con cara de Bob o Kevin'],
    addOns: [{ label: 'Vaso souvenir', price: 3 }],
    photoTip: 'El vaso ES el souvenir — sostenlo con la cara del minion hacia la cámara.',
    dietary: 'Vegano y sin gluten',
    guide: 'El mejor "value" de Minion Land: te llevas el vaso a casa para siempre.',
  },
];
