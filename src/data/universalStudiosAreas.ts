...
export const DIAGON_MEALS: Meal[] = [
  {
    ...
    name: 'Cornish Pasty (Leaky Cauldron) (Empanada de carne estilo córnico)', priceRange: '$13.99', tasteRating: 5, photogenicRating: 4, typicalWaitMin: 15,
  ...
  },
  {
    ...
    name: 'Butterbeer (frozen o caliente) (Cerveza de mantequilla)', priceRange: '$6.99 ($10.99 con vaso souvenir)', tasteRating: 5, photogenicRating: 5, typicalWaitMin: 5,
  ...
  },
  {
    ...
    name: 'Apple Crumble con Custard (Crumble de manzana con natilla)', priceRange: '$9.99', tasteRating: 5, photogenicRating: 4, typicalWaitMin: 15,
...
export const DREAMWORKS_MEALS: Meal[] = [
  {
    ...
    name: 'Shrek Swamp Waffle Cone (Cono de waffle del pantano de Shrek)', priceRange: '$8.99', tasteRating: 5, photogenicRating: 5, typicalWaitMin: 10,
  ...
  },
  {
    ...
    name: 'Trolls Pink Lemonade (vaso souvenir) (Limonada rosada de Trolls)', priceRange: '$6.50 ($9 con vaso)', tasteRating: 5, photogenicRating: 5, typicalWaitMin: 5,
...
export const SPRINGFIELD_MEALS: Meal[] = [
  {
    ...
    name: 'Krusty Burger Deluxe (Hamburguesa deluxe de Krusty)', priceRange: '$15.99', tasteRating: 4, photogenicRating: 4, typicalWaitMin: 10,
  ...
  },
  {
    ...
    name: 'Lard Lad Donuts (Donas de Lard Lad)', priceRange: '$8.99', tasteRating: 5, photogenicRating: 5, typicalWaitMin: 8,
  ...
  },
  {
    ...
    name: 'Milhouse\'s Squishy (vaso souvenir) (Granizado de Milhouse)', priceRange: '$6.50 ($9 con vaso)', tasteRating: 4, photogenicRating: 5, typicalWaitMin: 5,
...
export const WORLDEXPO_MEALS: Meal[] = [
  {
    ...
    name: 'Alien Slushy (vaso souvenir cabeza de alien) (Granizado alienígena)', priceRange: '$6.50 ($9 con vaso)', tasteRating: 4, photogenicRating: 5, typicalWaitMin: 5,
...
export const NEWYORK_MEALS: Meal[] = [
  {
    ...
    name: 'Classic NYC Hotdog (Perro caliente clásico de Nueva York)', priceRange: '$13.99', tasteRating: 5, photogenicRating: 4, typicalWaitMin: 10,
  ...
  },
  {
    ...
    name: 'Alchemy Bar Craft Cocktail (21+) (Cóctel artesanal del Alchemy Bar)', priceRange: '$14.99', tasteRating: 5, photogenicRating: 5, typicalWaitMin: 10,
